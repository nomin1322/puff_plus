    ...
    while running:
        ...
        if state == "RUNNING":
            ...
            if run["spawn_timer"] >= SPAWN_EVERY_S:
                ...
                if run["spawn_count"] % 2 == 0:
                    run["obstacles"].append(PipePair(WIDTH + 10))
                else:
                    run["obstacles"].append(TimingGatePair(WIDTH + 10))
            ...
            if state == "GAME_OVER":
                ...
                row = {
                    ...
                    "obstacle_family": run["death_family"],
                    "tap_count": tap_count,
        ...
        for o in run["obstacles"]:
            top, bottom = o.rects()
            color = (80, 200, 140) if o.family == "precision_gap" else (220, 170, 90)
